(function () {
  ...
  style.textContent = [
    ...
    "}",
    /* deep-space travel: two dim star layers drifting at different rates for parallax */
    "#tmx-chat::after {",
    "  content: '';",
    "  position: absolute;",
    "  inset: 0;",
    ...
    "  pointer-events: none;",
    "  background:",
    "    radial-gradient(1px 1px at 25% 20%, rgba(200,195,255,0.38), transparent 100%),",
    "    radial-gradient(1px 1px at 75% 70%, rgba(190,200,255,0.32), transparent 100%),",
    "    radial-gradient(0.8px 0.8px at 40% 80%, rgba(170,180,255,0.20), transparent 100%),",
    "    radial-gradient(0.8px 0.8px at 85% 25%, rgba(170,180,255,0.18), transparent 100%);",
    "  background-repeat: repeat;",
    "  background-size: 130px 160px, 130px 160px, 210px 250px, 210px 250px;",
    "  animation: tmx-chat-warp 42s linear infinite;",
    "}",
    "@keyframes tmx-chat-warp {",
    "  0%   { background-position: 0px 0px,    0px 0px,    0px 0px,    0px 0px;    }",
    "  100% { background-position: 0px -320px, 0px -320px, 0px -250px, 0px -250px; }",
    "}",
